...
class DetailsPageDrinks2 extends StatefulWidget {
  DetailsPageDrinks2({Key? key}) : super(key: key);
  @override
  _DetailsPageDrinks2State createState() => _DetailsPageDrinks2State();
}

int _isMealSelected = 2;
class _DetailsPageDrinks2State extends State<DetailsPageDrinks2> {

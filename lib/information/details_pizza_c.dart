...
class DetailsPagePizza2 extends StatefulWidget {
  DetailsPagePizza2( {Key? key}) : super(key: key);
  @override
  _DetailsPagePizza2State createState() => _DetailsPagePizza2State();
}

int _isMealSelected = 2;
class _DetailsPagePizza2State extends State<DetailsPagePizza2> {
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: const[
                        ...
                        Text("Ko'katlar , Pizza hamiri, \nTovuq go'shti, Pomidor , Ziravorlar",
                            style: TextStyle(
                              fontSize: 17.0,
                            )),
                      ],

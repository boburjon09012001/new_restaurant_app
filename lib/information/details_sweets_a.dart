...
class DetailsPageSweets extends StatefulWidget {
  DetailsPageSweets( {Key? key}) : super(key: key);
  @override
  _DetailsPageSweetsState createState() => _DetailsPageSweetsState();
}

int _isMealSelected = 0;
class _DetailsPageSweetsState extends State<DetailsPageSweets> {
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: const[
                        ...
                        Text("Pechine noni ,Malako va sut mahsulot-\nlari, mayda shirinliklar ",
                            style: TextStyle(
                              fontSize: 17.0,
                            )),
                      ],

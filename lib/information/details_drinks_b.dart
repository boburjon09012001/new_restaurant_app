...
class DetailsPageDrinks1 extends StatefulWidget {
  DetailsPageDrinks1({Key? key}) : super(key: key);
  @override
  _DetailsPageDrinks1State createState() => _DetailsPageDrinks1State();
}

int _isMealSelected = 1;
class _DetailsPageDrinks1State extends State<DetailsPageDrinks1> {

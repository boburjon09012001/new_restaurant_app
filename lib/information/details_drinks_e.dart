...
class DetailsPageDrinks4 extends StatefulWidget {
  DetailsPageDrinks4({Key? key}) : super(key: key);
  @override
  _DetailsPageDrinks4State createState() => _DetailsPageDrinks4State();
}

int _isMealSelected = 4;
class _DetailsPageDrinks4State extends State<DetailsPageDrinks4> {
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: const[
                        ...
                        Text("Qora coffe , Shakar , bazida Asal ",
                            style: TextStyle(
                              fontSize: 17.0,
                            )),
                      ],

...
class DetailsPageSweets4 extends StatefulWidget {
  DetailsPageSweets4( {Key? key}) : super(key: key);
  @override
  _DetailsPageSweets4State createState() => _DetailsPageSweets4State();
}

int _isMealSelected = 3;
class _DetailsPageSweets4State extends State<DetailsPageSweets4> {
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: const[
                        ...
                        Text("Malako va Sut mahsulotlari , Xamiri, \nQulupnay, Shakar , Tvarog,  ",
                            style: TextStyle(
                              fontSize: 17.0,
                            )),
                      ],

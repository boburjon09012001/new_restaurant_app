...
class DetailsPageDrinks5 extends StatefulWidget {
  DetailsPageDrinks5({Key? key}) : super(key: key);
  @override
  _DetailsPageDrinks5State createState() => _DetailsPageDrinks5State();
}

int _isMealSelected = 5;
class _DetailsPageDrinks5State extends State<DetailsPageDrinks5> {
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: const[
                        ...
                        Text("Sut va malako , Qora coffe ozgina ",
                            style: TextStyle(
                              fontSize: 17.0,
                            )),
                      ],

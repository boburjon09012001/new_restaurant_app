...
class DetailsPagePizza1 extends StatefulWidget {
  DetailsPagePizza1( {Key? key}) : super(key: key);
  @override
  _DetailsPagePizza1State createState() => _DetailsPagePizza1State();
}

int _isMealSelected = 0;
class _DetailsPagePizza1State extends State<DetailsPagePizza1> {

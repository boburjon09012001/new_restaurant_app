...
class DetailsPageSweets3 extends StatefulWidget {
  DetailsPageSweets3( {Key? key}) : super(key: key);
  @override
  _DetailsPageSweets3State createState() => _DetailsPageSweets3State();
}

int _isMealSelected = 2;
class _DetailsPageSweets3State extends State<DetailsPageSweets3> {
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: const[
                        ...
                        Text("Malako va Sut mahsulotlar , Xamiri, \nTvarog, Shakar",
                            style: TextStyle(
                              fontSize: 17.0,
                            )),
                      ],

...
class DetailsPagePizza3 extends StatefulWidget {
  DetailsPagePizza3( {Key? key}) : super(key: key);
  @override
  _DetailsPagePizza3State createState() => _DetailsPagePizza3State();
}

int _isMealSelected = 3;
class _DetailsPagePizza3State extends State<DetailsPagePizza3> {
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: const[
                        ...
                        Text("Ko'katlar ,Pizza hamiri, \nMol go'shti, Pomidor, Saryog', \nZiravorlar  , Tovuq go'shti",
                            style: TextStyle(
                              fontSize: 17.0,
                            )),
                      ],

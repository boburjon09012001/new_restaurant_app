...
class DetailsPageDrinks extends StatefulWidget {
  DetailsPageDrinks({Key? key}) : super(key: key);
  @override
  _DetailsPageDrinksState createState() => _DetailsPageDrinksState();
}

int _isMealSelected = 0;
class _DetailsPageDrinksState extends State<DetailsPageDrinks> {

...
class DetailsPageDrinks6 extends StatefulWidget {
  DetailsPageDrinks6({Key? key}) : super(key: key);
  @override
  _DetailsPageDrinks6State createState() => _DetailsPageDrinks6State();
}

int _isMealSelected = 6;
class _DetailsPageDrinks6State extends State<DetailsPageDrinks6> {
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: const[
                        ...
                        Text("Qahva kukuni , Sut va Malako ",
                            style: TextStyle(
                              fontSize: 17.0,
                            )),
                      ],
